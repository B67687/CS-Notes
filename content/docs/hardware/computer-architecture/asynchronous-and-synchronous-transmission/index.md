...
- It allows data to be sent back-to-back with minimal [ framing overhead](../transmission-extras/#framing), making it very efficient for high-speed or large-volume transfers.
...
- The solution is **brute-force resynchronization**:
  ...
  In **synchronous**: use [ phase-locked loops (PLL)](../transmission-extras/#phase-locked-loop-pll) or embedded clock recovery circuits to continuously adjust alignment — modern hardware does this millions of times per second.
