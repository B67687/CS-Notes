---
title: "🥨 Conversion to Binary Complement Forms"
date: 2025-11-08
draft: false
---
...
As seen in [ derived expression](../method-of-complements/), we have 2 ways to achieve it, through finding **radix complement** or the **diminished radix complement**
...
{{< callout type="default" >}}
**Converting to Negative with Signed Bit**
...
Because it is just `bitflips` , its `reversal` is also the same procedure
{{< /callout >}}
## 🐬 1's Complement Conversion Procedure
>
{{< callout type="info" >}}
