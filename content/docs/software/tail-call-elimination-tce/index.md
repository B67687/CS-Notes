...
Tail Call Elimination is a **programmer-level technique** that simulates [ Tail Call Optimisation](../tail-call-optimisation-tco/) by **refactoring recursion into iteration**. It enables deep recursion in languages that don’t support TCO (e.g. Python, Java) by avoiding stack growth altogether.
