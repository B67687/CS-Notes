...
Check out [ Boolean Algebra Laws](../boolean-algebra/#fundamental-laws-logical-form)
{{< /callout >}}
---
...
{{< callout type="info" >}}
**Karnaugh maps rely on the **Idempotent Law****
...
[ Why must it be in powers of 2?](../karnaugh-map-grouping/)
...
{{< callout type="info" >}}
**Prefer larger and more balanced groups**
...
[ A little bit more on Don't Cares](../dont-care-conditions-karnaugh-maps/)
